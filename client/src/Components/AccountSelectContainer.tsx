...
export const AccountSelectContainer = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col-reverse gap-5 max-h-[400px] overflow-scroll hiddenscrollbar">
        {Users?.map((user: UserDetailsType) => (
          <div
            key={user.id}
            className="flex border-b-2 border-white p-[8px] justify-between hover:bg-[#636363]"
          >
